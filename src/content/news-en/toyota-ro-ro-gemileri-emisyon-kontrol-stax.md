...
<p>Stax Engineering provides mobile emissions capture and control technology that can be used both onshore and on floating barge units for ship terminals and fleet operators. The technology can be deployed on vessels without any modifications and stands out as an alternative solution to shore power.</p>
<p><br></p>
<p>Toyota's Long Beach Vehicle Distribution Center imports approximately 200,000 vehicles annually via ro-ro vessels. Stax's flexible exhaust capture system connects to all vessel classes without modification, eliminating 99% of particulate matter (PM) emissions and 95% of nitrogen oxides (NOx). Over the lifetime of the new agreement with Toyota, Stax's service is estimated to cover approximately 3,700 operating hours and control more than 47 tons of emissions.</p>
<p><br></p>
...
<ul>
  ...
  <li><p>The agreement takes effect in 2025 in accordance with new CARB standards.</p></li>
  <li><p>Stax will be the first and only emissions control provider serving ro-ro vessels in California.</p></li>
  <li><p>Stax's technology can be used on vessels without requiring modifications.</p></li>
  <li><p>Toyota's Port of Long Beach operation imports 200,000 vehicles annually.</p></li>
