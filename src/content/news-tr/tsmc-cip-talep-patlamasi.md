...
image: "https://static.wixstatic.com/media/6c3915_514b25fa7e4d42f88f5753d3cdd14a1e~mv2.png/874.png"
...
<p><br></p>
<p style="text-align: justify"><strong>Coğrafi çeşitlendirme (geographic diversification)</strong>, TSMC’nin dayanıklılık stratejisinin temel ayağını oluşturuyor. Şirket, <strong>ABD (Arizona)</strong>, <strong>Japonya (Kumamoto)</strong> ve <strong>Avrupa (Almanya)</strong> gibi bölgelerde fab yatırımlarını genişleterek <strong>supply resilience (tedarik dayanıklılığı)</strong> sağlıyor. Bu adımlar aynı zamanda <strong>bölgesel yetenek havuzlarını</strong> ve <strong>tedarikçi ekosistemini</strong> büyüterek küresel operasyonel riskleri azaltıyor.</p>
<p><br></p>
<p style="text-align: justify">Üretim sürekliliği ve sürdürülebilirlik açısından, <strong>enerji ve su yönetimi</strong> fabrikaların (fab’lerin) performansında belirleyici rol oynuyor. TSMC, <strong>PPA (Power Purchase Agreement)</strong> anlaşmalarıyla yenilenebilir enerji kullanımını artırırken; <strong>su geri dönüşüm programları</strong> ile üretim süreçlerinde çevresel etkisini azaltıyor. Bu uygulamalar, sürdürülebilir üretim hedeflerinin bir parçası olarak operasyonel verimliliği de destekliyor.</p>
<p><br></p>
...
<ul>
  <li><p>N3/N2 ve CoWoS/HBM kapasitesi odaktadır.</p></li>
  <li><p>Coğrafi çeşitlendirme dayanıklılık sağlar.</p></li>
  <li><p>Enerji ve su yönetimi üretim için kritiktir.</p></li>
  <li><p>Uzun dönemli anlaşmalar kapasiteye erişimi güvenceye alır.</p></li>
