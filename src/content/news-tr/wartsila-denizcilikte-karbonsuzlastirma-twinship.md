...
sourceUrl: https://www.porttechnology.org/news/wartsila-joins-twinship-data-project/
category: Lojistik
...
<p><br></p>
<p>TwinShip projesi, bu ortakların uzmanlığını kullanarak, yeni inşalar ve retrofitler için makine, tahrik ve enerji tasarrufu sağlayan cihazların farklı kurulumlarını planlarken kullanılabilecek bir Karar Destek Sistemi (DSS) geliştirmeyi hedefliyor. Amaç, en iyi alan bilgisine dayalı olarak güvenilir maliyet, performans ve emisyon verileri sağlamaktır. Bu veriler, gerçek test verilerinin büyük miktarlarını analiz edebilen gelişmiş yapay zeka tabanlı algoritmalarla daha da geliştirilecek ve böylece daha hassas ve güvenilir sonuçlar elde edilecektir.</p>
<p><br></p>
<p>Projenin önemli bir bileşeni, gelişmiş AI algoritmalarının kullanılmasıyla büyük miktarda gerçek test verisinin analiz edilmesidir. Bu sayede, elde edilen verilerin doğruluğu ve güvenilirliği artırılarak, daha iyi tahminler ve karar destek mekanizmaları oluşturulacak. Projenin sonuçları, dört pilot gemi gösterimi ile doğrulanacak ve pratik uygulamaları test edilecek.</p>
<p><br></p>
<p>TwinShip, Uluslararası Denizcilik Örgütü'nün (IMO) 2023 Sera Gazı Stratejisi ile uyumlu olarak, endüstrinin sera gazı emisyonlarını azaltma hedefine destek olmak için iddialı kriterler belirleyecek. Merkezi bir unsur, filo verimliliğini optimize etmeye önemli ölçüde etki edecek güvenilir verilere ve öngörücü içgörülere erişim sağlamaktır; bu da daha iyi performans, daha düşük maliyetler ve azaltılmış emisyonlara yol açacaktır.</p>
<p><br></p>
...
<ul>
  <li><p>Wärtsilä, 'TwinShip' girişimine katılıyor.</p></li>
  <li><p>TwinShip, 2025-2028 yılları arasında sürecek ve Avrupa Birliği tarafından finanse ediliyor.</p></li>
  <li><p>Proje, ondan fazla teknoloji ve hizmet sağlayıcı, gemi tasarımı ve denizcilik şirketi, sınıflandırma kuruluşu, liman, yazılım geliştirici ve araştırma ve akademik kuruluşu içeriyor.</p></li>
  <li><p>Karar Destek Sistemi (DSS), yeni inşalar ve retrofitler için makine, tahrik ve enerji tasarrufu cihazlarının planlanmasında kullanılacak.</p></li>
  <li><p>Gelişmiş yapay zeka algoritmaları ile büyük miktarda gerçek test verisi analiz edilecek.</p></li>
  <li><p>Proje sonuçları, dört pilot gemi gösterimi ile doğrulanacak.</p></li>
  <li><p>TwinShip, IMO'nun 2023 Sera Gazı Stratejisi ile uyumlu olarak, sera gazı emisyonlarını azaltma hedefini destekliyor.</p></li>
  <li><p>Girişim, Wärtsilä'nın önceki EU projeleri olan SeaTech, CHEK, Green Ray ve Ammonia2-4'ün sonuçlarını kullanacak.</p></li>
