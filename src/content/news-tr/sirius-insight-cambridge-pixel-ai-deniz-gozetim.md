...
<p><br></p>
<p>Cambridge Pixel'in CEO'su David Johnson, "RadarWatch, birçok farklı radar ve kamera sensörüyle sorunsuz çalışıyor. Artırılmış görüşü uygulayarak, hedeflerin kamera video görüntüleri içinde etiketlenmesine izin veriyoruz, bu da daha hızlı, daha net ve daha iyi bilgilendirilmiş kararları mümkün kılıyor. Sirius Insight'ın öncü AI teknolojisiyle ideal bir ortaklık" diye belirtti.</p>
<p><br></p>
<p>Bu ortaklık, denizde güvenlik ve emniyeti artırmayı hedefleyen AI destekli teknolojilerin geliştirilmesinde önemli bir adım olarak görülüyor.</p>
<p><br></p>
<h5><strong>Önemli Notlar:</strong></h5>
<ul>
  <li><p>Sirius Insight, Cambridge Pixel ile AI destekli deniz gözetim çözümü geliştirmek için ortaklık kurdu.</p></li>
  <li><p>Cambridge Pixel'in radar izleme yazılımı, Sirius Insight'ın hizmetlerine entegre edildi.</p></li>
  <li><p>Radar verileri, AIS gibi ek iz raporlarıyla birleştiriliyor.</p></li>
  <li><p>PTZ kameralar ve bilgisayarlı görü sistemi, hedeflerin eylemlerini analiz ediyor.</p></li>
  <li><p>Veri bulutta depolanarak gerçek zamanlı izleme ve uyarıları destekliyor.</p></li>
  <li><p>Proje, AVx Video Link ve RadarWatch yazılımlarını içeriyor.</p></li>
