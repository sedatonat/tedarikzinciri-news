...
- siber saldırı
---
<p style="text-align: justify">Siber saldırganlar; üreticilerin henüz tam olarak özümsemediği bir gerçeği kavramış bulunuyor: Sıkı düzenlemelere tabi büyük ölçekli kurumlara ulaşmanın en kısa yolu, çoğunlukla tedarik zincirinden geçiyor. Bankalar, savunma yüklenicileri, sağlık sistemleri ve enerji şirketleri kendi güvenliklerine büyük yatırımlar yapıyor &mdash; ancak tedarikçileri çoğunlukla aynı düzeyde koruma sağlayamamakta. <strong>Üretim</strong> sektörü; tedarikçi portalları, partner entegrasyonları, müşteri arayüzleri ve bunları mümkün kılan formlar aracılığıyla neredeyse her sektöre bağlanıyor olduğu için bu dinamiğin tam merkezinde yer alıyor.</p>
<p><br></p>
<p style="text-align: justify">Yeni anket verileri; bu maruziyetin boyutunu somut biçimde ortaya koyuyor. Üretim kuruluşlarının %85'i son 24 ayda en az bir web formu kaynaklı güvenlik olayı yaşıyor &mdash; %42'si ise form gönderimlerine kadar izlenebilen gerçek bir veri ihlali doğruluyor. Üretim formlarını değerli kılan şey ise; finansal hizmetler veya sağlıktaki gibi ödeme kartı ya da korunan sağlık bilgisi yoğunluğu değil; <strong>fikri mülkiyet</strong>, ticari sırlar, mühendislik şartnameleri, üretim çizelgeleri, tedarikçi fiyatlandırması ve müşteri teknik gereksinimleri oluyor. Tedarik zinciri perspektifinden bakıldığında bu tür bilgiler; rekabet avantajının doğrudan kaynağı oluyor.</p>
<p><br></p>
